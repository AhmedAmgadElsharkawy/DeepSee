...
class EdgeDetectionsWindow(BasicStackedWindow):
    def __init__(self):
        ...
        self.controls_container_layout.addWidget(self.sobel_detector_inputs_container)
        ...
        self.controls_container_layout.addWidget(self.roberts_detector_inputs_container)
        ...
        self.controls_container_layout.addWidget(self.prewitt_detector_inputs_container)
        ...
        self.controls_container_layout.addWidget(self.canny_detector_inputs_container)
