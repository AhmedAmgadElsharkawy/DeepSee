...
class HoughTransformWindow(BasicStackedWindow):
    ...
    def __init__(self, main_window):
        ...
        self.ellipses_detection_canny_low_threshold_spin_box = CustomSpinBox(label="Low Threshold",range_start=0,range_end=500,initial_value=20,step_value=1)
        self.ellipses_detection_canny_high_threshold_spin_box = CustomSpinBox(label="high Threshold",range_start=0,range_end=500,initial_value=50,step_value=1)
