...
class CornerDetectionWindow(BasicStackedWindow):
    ...
    def __init__(self, main_window):
        ...
        self.harris_detector_block_size_spin_box = CustomSpinBox(label="Kernel Size",range_start=1,range_end=10,initial_value=1,step_value=1)
        ...
        self.harris_detector_k_factor_spin_box = CustomSpinBox(label="K Factor",range_start=0,range_end=1000,initial_value=1,step_value=0.1,double_value=True,decimals=2)
        ...
        self.lambda_detector_min_distance_spin_box = CustomSpinBox(label="Min Distance",range_start=1,range_end=1000,initial_value=5,step_value=1)
        ...
        self.harris_lambda_detector_block_size_spin_box = CustomSpinBox(label="Kernel Size",range_start=1,range_end=10,initial_value=1,step_value=1)
        ...
        self.harris_lambda_detector_k_factor_spin_box = CustomSpinBox(label="K Factor",range_start=0,range_end=1000,initial_value=1,step_value=0.1,double_value=True,decimals=2)
        ...
        self.harris_lambda_detector_min_distance_spin_box = CustomSpinBox(label="Min Distance",range_start=1,range_end=1000,initial_value=5,step_value=1)
