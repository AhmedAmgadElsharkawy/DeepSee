...
class SegmentationController():
    ...
    #
    # def mean_shift_segmentation(self,image, spatial_radius=15, color_radius=20, min_shift=0.2, max_iterations=20):
    #     """
    ...
    def agglomerative_segmention(self, image, final_k=10, initial_k=25):
        ...
        if len(image.shape) == 2 or (len(image.shape) == 3 and image.shape[2] == 1):
            ...
            print("[INFO] Converting grayscale image to 3-channel representation")
    ...
    def mean_shift_segmentation(self, image, spatial_radius=15, color_radius=20, min_shift=0.2, max_iterations=20):
        ...
        if is_grayscale:
            print("[INFO] Processing grayscale image")
